...
@Slf4j
@Component
public class BitfinexTra {
    @Value("${task.one}")
    private Boolean api;
    @Value("${task.one.apiKey}")
    private String apiKey;
    @Value("${task.one.apiSecret}")
...
//        final String apiKey = "LeynBy81llOl49DayHkdRdRX4iMARG3DDGrFYprI6IB";
//        final String apiSeret = "Q1DfiGRaZdGvBugAfL41vzixIIXKSSXS8ebDixD8zoi";
//       23
...
//        System.out.println("价格是"+prise+"  "+USD.getBalance());
        ...
        CoinAmount=CoinAmount.subtract(new BigDecimal("0.003"));
